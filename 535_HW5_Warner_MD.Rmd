...
#map by homicide areas in the city
ggplot()+
...
```
```{r}
#facets for unsolved vs solved with different colors to show races with highest# homicides for city
Denver_data %>%
  dplyr::mutate(disposition=forcats::fct_lump(disposition,n=2)) %>%
  dplyr::count(disposition)
